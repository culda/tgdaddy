  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="text-gray-700">
        ...
        <p>
          Welcome to Memberspage. We are committed to respecting the privacy of
          our users and ensuring the security of their personal information.
          This Privacy Policy outlines how we collect, use, disclose, and
          safeguard your data when you visit our website [Your Website URL].
        </p>
        <h2>2. Information Collection</h2>
        <p>
          We may collect personal identification information in various ways,
        ...
        <p>
          Memberspage may collect and use Users' personal information for the
          following purposes:
        </p>
        <ul>
        ...
        <p>
          Memberspage has the discretion to update this privacy policy at any
          time. When we do, we will post a notification on the main page of our
          Site and revise the updated date at the top of this page.
        </p>
        <h2>7. Your Acceptance of These Terms</h2>
        <p>
          By using this Site, you signify your acceptance of this policy. If you
          do not agree to this policy, please do not use our Site.
        </p>
        <h2>8. Contacting Us</h2>
        <p>
          If you have any questions about this Privacy Policy, the practices of
          this site, or your dealings with this site, please contact us at [Your
          Contact Information].
        </p>
      </div>
    </div>
