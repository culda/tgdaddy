  ...
  return (
    <section className="flex flex-grow relative pb-10 sm:items-center">
      <div className="w-14 absolute inset-0 flex items-center justify-center">
        ...
        ></div>
        <div className="flex-shrink-0 w-14 h-14 bg-blue-100 text-blue-500 rounded-full inline-flex items-center justify-center absolute -translate-y-2/4"></div>
      </div>
      <div className="flex-grow pl-20 flex sm:items-center items-start flex-row">
