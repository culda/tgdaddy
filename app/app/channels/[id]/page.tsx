...
import EditableForm from "@/app/components/ChannelInfoForm";

type PpChannel = {
  params: { id: string };
};

export default function Page({ params }: PpChannel) {
  const session = useSession();
  const [channel, setChannel] = useState<StChannel | null>(null);
