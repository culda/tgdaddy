...
const { LDD_PATH, readFile, readFileSync } = __webpack_require__(913);
...
const is = __webpack_require__(482);
...
const util = __webpack_require__(261);
const stream = __webpack_require__(492);
const is = __webpack_require__(482);
...
const Sharp = __webpack_require__(300);
__webpack_require__(800)(Sharp);
__webpack_require__(102)(Sharp);
__webpack_require__(847)(Sharp);
__webpack_require__(694)(Sharp);
__webpack_require__(409)(Sharp);
__webpack_require__(988)(Sharp);
__webpack_require__(583)(Sharp);
__webpack_require__(466)(Sharp);
...
const color = __webpack_require__(767);
const is = __webpack_require__(482);
const sharp = __webpack_require__(257);
...
const { spawnSync } = __webpack_require__(718);
...
const { engines, optionalDependencies } = __webpack_require__(200);
...
const { familySync, versionSync } = __webpack_require__(897);

const { runtimePlatformArch, prebuiltPlatforms, minimumLibvipsVersion } = __webpack_require__(868);
...
for (const path of paths) {
  try {
    sharp = __webpack_require__(16)(path);
    break;
  } catch (err) {
    /* istanbul ignore next */
    errors.push(err);
...
if (sharp) {
  ...
  if (isLinux && /(symbol not found|CXXABI_)/i.test(messages)) {
    try {
      const { engines } = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'undefined'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const events = __webpack_require__(673);
const detectLibc = __webpack_require__(897);

const is = __webpack_require__(482);
const { runtimePlatformArch } = __webpack_require__(868);
const sharp = __webpack_require__(257);
...
if (!libvipsVersion.isGlobal) {
  if (!libvipsVersion.isWasm) {
    try {
      versions = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'undefined'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    } catch (_) {
      try {
        versions = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'undefined'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
      } catch (_) {}
